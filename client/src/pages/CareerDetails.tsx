...
export default function CareerDetails() {
  ...
  useEffect(() => {
    ...
    const initializeCareerDetails = () => {
      ...
      const fetchCareerDetailsData = async () => {
        try {
          const data = await fetchCareerDetails(Number(careerId));
          setCareer(data);
          setError(null);
        } catch (err) {
  ...
  const getCareerImage = (career: any) => {
    ...
    if (name.includes("engineer"))
      return "https://images.unsplash.com/photo-1581094288338-2314dddb7ece?w=600&h=400&fit=crop";
    ...
    if (name.includes("doctor"))
      return "https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=600&h=400&fit=crop";
    ...
    if (name.includes("lawyer"))
      return "https://images.unsplash.com/photo-1556157382-97eda2d62296?w=600&h=400&fit=crop";
        ...
        <div className="container py-5">
          <div className="row">
            <div className="col-12">
              <div className="placeholder-glow">
                ...
                ></div>
                <div
                  className="placeholder col-4 mb-4"
                  style={{ height: "1.5rem" }}
                ></div>
              </div>
            </div>
          ...
          <div className="row g-4">
            <div className="col-lg-8">
              <div className="placeholder-glow">
                <div
                  className="placeholder w-100 mb-4"
                  style={{ height: "300px" }}
                ></div>
                <div
          ...
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb mb-0">
              <li className="breadcrumb-item">
                <a href="/future-careers" className="text-decoration-none">
                  Future Careers
                </a>
              </li>
        ...
        <div className="container">
          <div className="text-center mb-5">
            ...
            <div className="d-flex justify-content-center gap-3 flex-wrap">
              ...
              <span
                className={`badge px-3 py-2 ${
                  career.status === 1 ? "bg-success" : "bg-danger"
                }`}
              >
            ...
            <div className="col-lg-8">
              ...
              {career.overview && (
                <div className="mb-5">
                  ...
                  <p className="text-muted lh-lg">{career.overview}</p>
                </div>
              )}

              <div className="d-flex gap-3 flex-wrap">
                <Button className="btn-primary-orange btn-lg px-4 py-4">
                  <i className="fas fa-search me-2"></i>
                  Find Related Courses
                </Button>
                <Button className="btn-secondary-green btn-lg px-4 py-4">
                    ...
                    <div className="d-flex flex-column gap-3 text-sm">
                      ...
                      <div className="d-flex justify-content-between">
                        ...
                        <span className="fw-medium">
                          {career.serial_no || "Not specified"}
                        </span>
                      </div>
                      <div className="d-flex justify-content-between">
        ...
        <div className="container">
          <div className="row g-5 align-items-center">
            <div className="col-lg-6">
              ...
              <p className=" text-muted mb-4">
                Get personalized guidance from our career experts. We'll help
                you understand the requirements, opportunities, and next steps
            ...
            <div className="col-lg-6">
              <div className="bg-white p-4 rounded-3 shadow-sm">
                ...
                <p className="text-muted mb-4">
                  Schedule a consultation with our career experts
                </p>
                ...
                <form id="contact-form">
                  <div className="row g-3">
                    ...
                    <div className="col-12">
                      <Button
                        type="submit"
                        className="btn btn-primary-orange w-100 py-4 fw-semibold"
                        id="submit-btn"
                      >
                        Submit Inquiry
                      </Button>
